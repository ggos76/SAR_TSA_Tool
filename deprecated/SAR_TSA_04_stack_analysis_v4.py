    ...
    if use_catalyst is True:
       ...
       # 1) We need to create the output file name
        ...
        if output_type == 1: # analysis layers only
            ...
            stack =  "no"							
            output_file =  os.path.join(Fld_output_stacks, base_stack + out_filter + "_TSA_stack_analysis.pix")
        if output_type == 2:  # analysis and stack together
            ...
            stack =  "yes"
            output_file =  os.path.join(Fld_output_stacks, base_stack + out_filter + "_TSA_stack_analysis_and_data.pix")
        if output_type == 3:  # analysis and stack separate
            ...
            out_type3_analysis =  os.path.join(Fld_output_stacks, base_stack + out_filter + "_TSA_stack_analysis.pix")
            out_type3_data =  os.path.join(Fld_output_stacks, base_stack + out_filter + "_TSA_stack_data.pix")
